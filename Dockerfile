...
RUN     pip install --install-option="--prefix=/var/lib/graphite" --install-option="--install-lib=/var/lib/graphite/webapp" git+https://github.com/bluelabsio/graphite-web.git@0.9.12-perf
